...
export default function CTA() {
  ...
  return (
    <section className="relative bg-charcoal py-20 lg:py-24 overflow-hidden" ref={revealRef}>
      {/* Background gradient */}
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal-hidden">
        <div className="w-14 h-14 rounded-2xl bg-gold/10 border border-gold/30 flex items-center justify-center mx-auto mb-6 animate-float">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="group inline-flex items-center justify-center gap-3 bg-gold hover:bg-gold-light text-charcoal font-bold text-base px-8 py-4 rounded-xl transition-all duration-300 hover:shadow-[0_0_40px_rgba(212,175,55,0.5)] hover:scale-[1.02] active:scale-[0.98]"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 border border-white/20 hover:border-gold/40 text-white font-semibold text-base px-8 py-4 rounded-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
          >
