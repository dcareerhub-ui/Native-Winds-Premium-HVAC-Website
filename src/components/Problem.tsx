      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-14">
          {PAIN_POINTS.map(({ icon: Icon, title, desc }) => (
            <div
              key={title}
              className="group bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.07] hover:border-red-500/20 rounded-2xl p-6 transition-all duration-300"
            >
        ...
        {/* Callout */}
        <div className="relative bg-gradient-to-r from-gold/10 via-gold/5 to-transparent border border-gold/20 rounded-2xl px-8 py-6 max-w-3xl mx-auto text-center">
