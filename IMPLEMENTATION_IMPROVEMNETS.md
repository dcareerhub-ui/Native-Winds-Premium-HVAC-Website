...
- [ ] **Before & After Gallery**
  - [ ] Create a "Swipe-to-Compare" component for HVAC repair results.
  - [ ] Select or generate 3-4 high-quality repair comparison images.
- [ ] **Interactive Service Map**
  - [ ] Integrate a dark-themed Mapbox/Google Map.
  - [ ] Add glowing markers for "Recent Service Areas" (Chandler, Gilbert, etc.).
- [ ] **Premium Typography Upgrade**
  - [ ] Introduce a high-end Serif font (e.g., *Outfit* or *Playfair*) for `<h1>` and `<h2>` tags.
  - [ ] Refine line-heights and letter-spacing for better readability on dark backgrounds.
- [ ] **Custom Iconography**
  - [ ] Add subtle gold gradients or glows to the Lucide icons.
